...
public class CustomerController 
{
	...
	public Customer updateCustomerByUserName(@PathVariable("userName") String userName,@RequestBody Customer cust) throws InvalidPhoneNumberException
	{
